		...
		<div class="login-top">
			<form action="" name="loginForm" method="post" onsubmit="return loginconfirm()"> 
				...
				<div class="login-icons" style= "width: 100%;">
					...
					<button style="width: 130px; height: 40px;" class="btns-wrap__submit-btn" type="button" onclick="location.href='${pageContext.servletContext.contextPath }/owner/regist';">업체 회원가입</button>
