	...
	<thead>
		...
		<tbody>
			<tr class="tr1">
				...
				<td>
					<div class="warning">
						<p> * 사업자 등록상 같은 예금명, 계좌번호로 등록해주시기 바랍니다.</p>
					</div>
					<div class="basic">
						<span class="form-title" style="display:inline-block";>거래 은행    </span>
						<span>
							<select name="bank" class="select-nomalsize" required>
					...
					<div class="basic">
						<span class="form-title" style="display:inline-block";> 예금주  </span>
						<input class="select-nomalsize" type="text" name="account_holder" placeholder="이름을 입력하세요." value="" required>
					</div>
					<div class="basic" >
						<span class="form-title" style="display:inline-block";> 계좌 번호  </span>
						<input style="background-color:lightgrey ; border-radius: 4px;" class="select-nomalsize" type="text" name="account_holder" placeholder="고객센터 이메일로 계좌번호를 보내주세요." value="" disabled="disabled">
					</div>
					<p class="description">정산은 매월 첫째주 수요일에 정산 됩니다. <br>
					자세한 사항은 고객행복문의센터에 문의해 주시기 바랍니다.</p>
				</td>
			</tr>
			<tr class="tr1">
				<th>
