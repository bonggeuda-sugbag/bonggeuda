	...
	<div class="container">
		...
		<div class="top-nav">
			<ul class="right-icons">
				<li><a href="registration.jsp">숙소등록</a></li>
				<li><a href="managementYesRoom.jsp">숙소관리</a></li>
				<li><a href="booking.jsp">예약관리</a></li>
				<li><a href="QnA.jsp">공지사항</a></li>
	...
	<div class="todo-layer">
		<nav>
			<ul class="stepbox" id="ulStep">
				...
				<li>
				<a href="registration2-intro.jsp">                        
				...
				<li>
				<a href="registration4-room.jsp">                        
					<span class="btn-todo-on"><img src="../img/icon/step4.png" width="64px" height="64px"></span>
					<br><br>
