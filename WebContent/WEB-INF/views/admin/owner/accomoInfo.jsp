	...
	<!--  <div id="btn3_content">
			<div style="margin: 0 auto;">
				...
				<c:choose>
					...
					<c:when
						test="${ accomo.reviewScore ge 1 &&  accomo.reviewScore lt 1.5}">
						<h3>1점이상1.5미만이에요</h3>
						<br>
						<div style="display: flex; width: 180px; margin: 0 auto;">
					...
					<c:when
						test="${ accomo.reviewScore ge 1.5 && accomo.reviewScore lt 2}">
						<h3>1.5이상와2미만에요</h3>
						<br>
						<div style="display: flex; width: 180px; margin: 0 auto;">
					...
					<c:when
						test="${ accomo.reviewScore ge 2 && accomo.reviewScore lt 2.5}">
						<h3>2이상 2.5미만</h3>
						<br>
						<div style="display: flex; width: 180px; margin: 0 auto;">
					...
					<c:when
						test="${ accomo.reviewScore le 2 && accomo.reviewScore lt 3}">
						<h3>2.5이상점과 3점미만</h3>
						<br>
						<div style="display: flex; width: 180px; margin: 0 auto;">
					...
					<c:when
						test="${ accomo.reviewScore ge 3 && accomo.reviewScore lt 3.5}">
						<h3>3과 3.5 사이이에요</h3>
						<br>
						<div style="display: flex; width: 180px; margin: 0 auto;">
					...
					<c:when
						test="${ accomo.reviewScore ge 3.5 && accomo.reviewScore lt 4}">
						<h3>3.5와 4 사이에요</h3>
						<br>
						<div style="display: flex; width: 180px; margin: 0 auto;">
					...
					<c:when
						test="${ accomo.reviewScore ge 4 && accomo.reviewScore lt 4.5}">
						<h3>4점이에요</h3>
						<br>
						<div style="display: flex; width: 180px; margin: 0 auto;">
					...
					<c:when
						test="${ accomo.reviewScore ge 4.5 && accomo.reviewScore lt 5}">
						<h3>4와 5사이에요</h3>
						<br>
						<div style="display: flex; width: 180px; margin: 0 auto;">
					...
					<li>
						<div class="guestReview">
							...
							<div class="reviewTitle">
								...
								<div class="like" id="like${best.reviewNo}"
									value='${best.reviewNo}'></div>
								<div>
									<p name="review${best.reviewNo}">${best.upCnt }</p>
								</div>
								<div class="unlike" id="unlike${best.reviewNo}"
									value='${best.reviewNo}'></div>
								<div>
									<p name="review${best.reviewNo}">${best.downCnt }</p>
								</div>
							</div>
							...
							<div class="reviewScore" style="display: flex;">
								<c:choose>
									<c:when test="${ best.starPoint eq 1}">
										<div
											style="display:flex;width: 90px; height:18px;background: url(${pageContext.servletContext.contextPath }/resources/guest/images/reviewStar.png) 0 0 no-repeat; background-size: 90px auto; background-position: 0 -147px;">
										</div>
									</c:when>
									<c:when test="${ best.starPoint eq 2}">
										<div
											style="display:flex;width: 90px; height:18px;background: url(${pageContext.servletContext.contextPath }/resources/guest/images/reviewStar.png) 0 0 no-repeat; background-size: 90px auto; background-position: 0 -110px;">
										</div>
									</c:when>
									<c:when test="${ best.starPoint eq 3}">
										<div
											style="display:flex;width: 90px; height:18px;background: url(${pageContext.servletContext.contextPath }/resources/guest/images/reviewStar.png) 0 0 no-repeat; background-size: 90px auto; background-position: 0 -73px;">
										</div>
									</c:when>
									<c:when test="${ best.starPoint eq 4}">
										<div
											style="display:flex;width: 90px; height:18px;background: url(${pageContext.servletContext.contextPath }/resources/guest/images/reviewStar.png) 0 0 no-repeat; background-size: 90px auto; background-position: 0 -35px;">
										</div>
									</c:when>
									<c:when test="${ best.starPoint eq 5}">
										<div
											style="display:flex;width: 90px; height:18px;background: url(${pageContext.servletContext.contextPath }/resources/guest/images/reviewStar.png) 0 0 no-repeat; background-size: 90px auto; background-position: 0 0;">
										</div>
									</c:when>
								</c:choose>
							...
							<div class=reviewPicture
								style=" width : 300px; height: 170px; display: block;background: url(${pageContext.servletContext.contextPath }/${best.attachment.thumbnailPath }); background-size: 300px 170px;">
							</div>
						</div>
					</li>
				</c:forEach>
					...
					<li>
						<div class="guestReview">
							<div class="reviewTitle">
								<div>
									<h4>
										<strong>${normalReview.title}</strong>
									</h4>
								</div>
								<div class="like" id="like${normalReview.reviewNo}"
									value='${normalReview.reviewNo}'></div>
								<div>
									<p name="review${normalReview.reviewNo}">${normalReview.upCnt }</p>
								</div>
								<div class="unlike" id="unlike${normalReview.reviewNo}"
									value='${normalReview.reviewNo}'></div>
								<div>
									<p name="review${normalReview.reviewNo}">${normalReview.downCnt }</p>
								</div>
							</div>
							<div class="reviewScore" style="display: flex;">
								<c:choose>
							...
							<div class="suksoName">
								<p>닉네임</p>
								<b> · ${normalReview.nickName }</b>
							</div>
							<div class=reviewContext>
								<p>${normalReview.content}</p>
							</div>
							<div class=reviewPicture
								style=" width : 300px; height: 170px; display: block;background: url(${pageContext.servletContext.contextPath }/${normalReview.attachment.thumbnailPath }); background-size: 300px 170px;">
							</div>
						</div>
					</li>
				</c:forEach>
