				...
				<div class="blog-list">
					<nav>
						<div class="col-md-3 blog-sidebar">
							<ul>
								<li class="blog-list"><a href="userInfo.jsp"
									style="color: #6eceda; font-size: 1.3em; font-weight: 600;">사용자
										정보</a></li>
								<li class="blog-list"><a href="userBlist.jsp">블랙리스트 회원</a></li>
								<li class="blog-list"><a
									href="adminUserManagementLeave.html">탈퇴 회원</a></li>
							</ul>
					</nav>
