...
<div class="container">
	...
	<div class="FAQ_tab" data-default="term">
		<ul class="FAQ_tab" style="display: flex;">
			...
			<li style="margin-right: 20px;"><a href="FAQ2.html" style="color: #6eceda; font-weight: bold;">쿠폰/포인트</a></li>
	...
	<div id="cont_area"><!-- 본문 콘텐츠-->
		<div class="cont_inner" id="policy_page" style="min-height: 435px; text-align: left; float: left;">
			...
			<div style="font-weight: bold;">쿠폰함에서 쿠폰이 사라졌어요.</div><br>
			...
			<br><div style="font-weight: bold;">무료초대권은 어떻게 사용하나요?</div><br>
			...
			<br><div style="font-weight: bold;">예약 시 사용가능한 쿠폰이 없어요.</div><br>
			...
			<br><div style="font-weight: bold;">사용한 쿠폰을 쿠폰함에서 삭제하고 싶어요.</div><br>
			<p style="font-size: 13.3333px; background: #e9ebebbe;"><br>사용 완료된 쿠폰 내역은 앱 하단 더보기 &gt; 사용내역 관리 &gt; 쿠폰함에서 삭제가 가능합니다.
			<br><br></p>

			<br><div style="font-weight: bold;">지류 쿠폰은 어떻게 등록하나요?</div><br>
