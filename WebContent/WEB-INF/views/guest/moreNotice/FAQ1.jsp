...
<head>
	...
	/* .FAQ_tab .active:after, FAQ_.tab .tab_btn.active:active {
    display: block;
    content: '';
    position: absolute;
    bottom: 0;
...
<div class="header">
	<div class="container">
		...
		<div class="top-nav">
            ...
            <li><a  href="login.html"><i class="glyphicon glyph   icon-user"> </i>로그인</a></li>
			</ul>
...
<div class="container">
	...
	<div class="FAQ_tab" data-default="term">
		<ul class="FAQ_tab" style="display: flex;">
			<li style="margin-right: 20px;"><a href="FAQ1.html" style="color: #6eceda; font-weight: bold;"><span class="tab_btn active">예약취소</span></a></li>
			<li style="margin-right: 20px;"><a href="FAQ2.html">쿠폰/포인트</a></li>
			<li style="margin-right: 20px;"><a href="FAQ3.html">회원정보</a></li>
	...
	<div id="cont_area"><!-- 본문 콘텐츠-->
		<div class="cont_inner" id="policy_page" style="min-height: 435px; text-align: left; float: left;">
			...
			<div style="font-weight: bold;">예약을 취소하고 싶어요.</div><br>
			...
			<br><div style="font-weight: bold;">천재지변으로 인한 예약취소는 어떻게 하나요?</div><br>
			...
			<br><div style="font-weight: bold;">예약대기 건 예약취소하고 싶어요.</div><br>
			...
			<br><div style="font-weight: bold;">숙소에서 예약취소 했어요. 어떻게 하나요?</div><br>
			...
			<br><div style="font-weight: bold;">체크인날짜/객실타입을 변경하고 싶어요.</div><br>
			...
			<br><div style="font-weight: bold;">취소수수료 계산 기준은 어떻게되나요?</div><br>
			...
			<br><div style="font-weight: bold;">전월 휴대폰 결제 취소는 어떻게 하나요?</div><br>
			...
			<br><div style="font-weight: bold;">예약취소했는데 언제 환불되나요?</div><br>
