...
<div class="container">
	...
	<div id="cont_area"><!-- 본문 콘텐츠-->
		<div class="cont_inner" id="policy_page" style="min-height: 435px; text-align: left; float: left;">
			...
			<div style="font-weight: bold;">회원탈퇴는 어떻게 하나요?</div><br>
            ...
            <br><div style="font-weight: bold;">개인이 여러 개의 아이디를 만들 수 있나요?</div><br>
			...
			<br><div style="font-weight: bold;">아이디와 비밀번호를 잊었어요.</div><br>
            ...
            <br><div style="font-weight: bold;">회원정보 수정은 어떻게 하나요?</div><br>
